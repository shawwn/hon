// (C)2006 S2 Games
// mesh_colored_unlit.vsh
// 
// Vertex shader for unlit meshes with a color channel
//=============================================================================
...
// Material properties
float		fTexcoordSpeedX, fTexcoordSpeedY;
...
VS_OUTPUT VS( VS_INPUT In )
{
	...
	Out.Texcoord0     = In.Texcoord0 + float2(fTexcoordSpeedX * fTime, fTexcoordSpeedY * fTime);
