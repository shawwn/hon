...
/*====================
  ...
  Bounds A is moving
  ====================*/
bool	I_MovingBoundsBoundsIntersect(const CVec3f &v3Start, const CVec3f &v3End, const CBBoxf &bbBoundsA, const CBBoxf &bbBoundsB, float &fFraction, CPlane *pPlaneHit, bool *pbStartInSurface)
{
