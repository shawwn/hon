...
public:
	...
	CVec3<T>&	MultAdd(const CVec3<T> &b, float f)
	{
...
template <class T>
inline
CVec3<T> CrossProduct(const CVec3<T> &a, const CVec3<T> &b)
{
	return CVec3<T>(
		a.y * b.z - a.z * b.y,
		a.z * b.x - a.x * b.z,
...
template <class T>
inline
T	DotProduct(const CVec3<T> &a, const CVec3<T> &b)
{
...
template <class T>
inline
CVec3<T>	Normalize(const CVec3<T> &a)
{
	float fLength = sqrt(a.x * a.x + a.y * a.y + a.z * a.z);

	if (fLength == 0.0f)
	{
		return CVec3<T>(0.0f, 0.0f, 0.0f);
	}

	return CVec3<T>(a.x / fLength, a.y / fLength, a.z / fLength);
}
...
template <class T>
inline
CVec3<T>	Normalize(const CVec3<T> &a, T &_Length)
{
	float fLength = sqrt(a.x * a.x + a.y * a.y + a.z * a.z);
...
template <class T>
inline
T	Distance(const CVec3<T> &a, const CVec3<T> &b)
{
	T	dx = a.x - b.x;
	T	dy = a.y - b.y;
	T	dz = a.z - b.z;
...
template <class T>
inline
T	DistanceSq(const CVec3<T> &a, const CVec3<T> &b)
{
	T	dx = a.x - b.x;
	T	dy = a.y - b.y;
	T	dz = a.z - b.z;
...
template <class T>
inline
bool	Compare(const CVec3<T> &a, const CVec3<T> &b)
{
...
template <class T>
inline
bool	Compare(const CVec3<T> &a, const CVec3<T> &b, float fEpsilon)
{
...
template <class T>
inline
CVec3<T>	Project(const CVec3<T> &a, const CVec3<T> &b)
{
...
template <class T>
inline
CVec3<T>	NormalProject(const CVec3<T> &aNormalized, const CVec3<T> &b)
{
...
template <class T>
inline
CVec3<T>	Prependicular(const CVec3<T> &a, const CVec3<T> &b)
{
...
template <class T>
inline
CVec3<T>	NormalPrependicular(const CVec3<T> &aNormalized, const CVec3<T> &b)
{
...
template <class T>
inline
CVec3<T>	Clip(const CVec3<T> &a, const CVec3<T> &n, float fFudge = 1.000f)
{
...
template <class T>
inline
CVec3<T>	Reflect(const CVec3<T> &a, const CVec3<T> &n, float fBounce)
{
...
template <class T>
inline
void	Decompose(const CVec3<T> &v3Vec, CVec3<T> &v3Dir, float &fLength)
{
...
template <class T>
inline
CVec3<T>	Orthogonalize(const CVec3<T> &a, const CVec3<T> &b)
{
