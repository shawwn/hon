...
template <class T>
inline
CVec3<T> Multiply(const CMatrix3x3<T> &a, const CVec3<T> &b)
{
	return CVec3<T>
	(
...
template <class T>
inline
CMatrix3x3<T> Multiply(const CMatrix3x3<T> &a, const CMatrix3x3<T> &b)
{
	return CMatrix3x3<T>
	(
...
template <class T>
inline
CMatrix3x3<T> Inverse(const CMatrix3x3<T> &m)
{
}
