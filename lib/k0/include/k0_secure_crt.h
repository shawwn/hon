...
//=============================================================================
#ifndef __K0_SECURE_CRT_H__
#define __K0_SECURE_CRT_H__
...
#define DECLARE_TIME_STRUCT_S(name)				struct tm	_name, *name(&_name);
...
#define _TFOPEN_S(file, filename, mode)			((file = fopen(filename, mode)) != NULL)
