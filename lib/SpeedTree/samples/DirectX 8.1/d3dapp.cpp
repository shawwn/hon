...
//    pDeviceInfo->DeviceType = D3DDEVTYPE_HAL; // for shader debugging
...
//  pModeInfo->dwBehavior += D3DCREATE_MIXED_VERTEXPROCESSING ;
...
//-----------------------------------------------------------------------------
int CALLBACK CD3DApplication::SelectDeviceProc( HWND hDlg, UINT msg,
