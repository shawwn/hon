...
STEAM_API int				STEAM_CALL	SteamGetAppPurchaseCountry( unsigned int uAppId, char *szCountryBuf, unsigned int uBufSize, int * pPurchaseTime, TSteamError *pError );
...
STEAM_API int				STEAM_CALL	SteamGetAppUserDefinedRecord( unsigned int uAppid, KeyValueIteratorCallback_t pIterationCallback, void *pvParam, TSteamError *pError );
...
STEAM_API int				STEAM_CALL	SteamGetCacheDecryptionKey( unsigned int uCacheId, char *pchHexKeyBuffer, unsigned int cubBuff, unsigned int *pcubKey, TSteamError *pError );
...
/*
** Formerly in ValidateNewValveCDKeyClient.lib
*/
