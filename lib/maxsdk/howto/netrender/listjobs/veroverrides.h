...
#define MAXVER_INTERNALNAME "listjobs\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "listjobs.exe\0"//should  be overidden on a per-dll level
