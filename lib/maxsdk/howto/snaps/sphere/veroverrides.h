...
#define MAXVER_INTERNALNAME "sphere\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "sphere.dls\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Quadrant and center of sphere snaps (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: john.hutchinson\0"//should  be overidden on a per-dll level
