...
#define MAXVER_INTERNALNAME "sampleEff\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "sampleEff.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Sample Effect (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH:kells.elmquist\0"//should  be overidden on a per-dll level
