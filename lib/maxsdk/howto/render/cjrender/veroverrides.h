...
#define MAXVER_INTERNALNAME "cjrender\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "cjrender.dlr\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Sample renderer (plugin)\0"//should  be overidden on a per-dll level
