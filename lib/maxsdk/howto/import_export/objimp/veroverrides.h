...
#define MAXVER_INTERNALNAME "objimp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "objimp.dli\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Wavefront OBJ file importer (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: don.brittain\0"//should  be overidden on a per-dll level
