...
#define MAXVER_INTERNALNAME "testdlx\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "testdlx.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Sample MaxScript plugin\0"//should  be overidden on a per-dll level
