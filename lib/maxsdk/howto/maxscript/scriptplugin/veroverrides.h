...
#define MAXVER_INTERNALNAME "ScPRead\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ScPRead.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Scripted Plugin Reader Utility\0"//should  be overidden on a per-dll level
