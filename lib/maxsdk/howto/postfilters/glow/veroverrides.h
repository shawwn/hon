...
#define MAXVER_INTERNALNAME "glow\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "glow.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Glow image filter (plugin)\0"//should  be overidden on a per-dll level
