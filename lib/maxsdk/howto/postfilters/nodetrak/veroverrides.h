...
#define MAXVER_INTERNALNAME "nodetrak\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "nodetrak.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Node track image filter (plugin)\0"//should  be overidden on a per-dll level
