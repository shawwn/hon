...
#define MAXVER_INTERNALNAME "widget\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "widget.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Widget Object Implementation\0"//should  be overidden on a per-dll level
