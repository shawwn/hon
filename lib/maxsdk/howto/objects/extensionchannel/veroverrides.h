...
#define MAXVER_INTERNALNAME "XModifier\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "XModifier.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Extension Object Modifier and Object\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: Nikolai Sander\0"//should  be overidden on a per-dll level
