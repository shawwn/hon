...
#define MAXVER_INTERNALNAME "PerFaceData\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PerFaceData.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Example of adding Face Data\0"//should  be overidden on a per-dll level
