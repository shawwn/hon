...
#define MAXVER_INTERNALNAME "CustomVData\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CustomVData.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "CustomVData\0"//should  be overidden on a per-dll level
