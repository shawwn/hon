...
#define MAXVER_INTERNALNAME "CVDExport\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CVDExport.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "CVDExporter\0"//should  be overidden on a per-dll level
