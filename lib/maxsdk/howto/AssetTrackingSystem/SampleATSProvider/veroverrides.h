...
#define MAXVER_INTERNALNAME "SampleATSProvider\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SampleATSProvider.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "SampleATSProvider\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: michael.russo\0"//should  be overidden on a per-dll level
