...
#define MAXVER_INTERNALNAME "testLayerA\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "testLayerA.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Test Layer Implementation\0"//should  be overidden on a per-dll level
