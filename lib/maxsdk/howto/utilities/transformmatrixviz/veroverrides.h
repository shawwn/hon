...
#define MAXVER_INTERNALNAME "TMatTest\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "TMatTest.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Transformation matrix tester (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: chuck.lingle\0"//should  be overidden on a per-dll level
