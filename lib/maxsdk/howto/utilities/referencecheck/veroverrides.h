...
#define MAXVER_INTERNALNAME "RefCheck\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "RefCheck.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Reference checker utility (plugin)\0"//should  be overidden on a per-dll level
