...
#define MAXVER_INTERNALNAME "DynPBlock\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "DynPBlock.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Example showing how to use Custom Attributes\0"//should  be overidden on a per-dll level
