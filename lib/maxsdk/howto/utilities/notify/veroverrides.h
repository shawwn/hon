...
#define MAXVER_INTERNALNAME "Notify\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Notify.EXE\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Network renderer notification application\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: gus.grubba\0"//should  be overidden on a per-dll level
