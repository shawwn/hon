...
#define MAXVER_INTERNALNAME "Xrefutil\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Xrefutil.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Sample XRef Utility\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "XRef Utility Sample -- Discreet Developer Consulting Group\0"//should  be overidden on a per-dll level
