...
#define MAXVER_INTERNALNAME "CCUtil\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CCUtil.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "CurveControl Utility (plugin)\0"//should  be overidden on a per-dll level
