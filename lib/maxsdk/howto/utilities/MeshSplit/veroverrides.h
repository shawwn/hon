...
#define MAXVER_INTERNALNAME "ApplyVC\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ApplyVC.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Vertex color utility and modifier (plugin)\0"//should  be overidden on a per-dll level
