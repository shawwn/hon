...
#define MAXVER_INTERNALNAME "SampleShaderPlugin\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SampleShaderPlugin.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Sample Hardware Shader\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: rodolfo.cazabon\0"//should  be overidden on a per-dll level
