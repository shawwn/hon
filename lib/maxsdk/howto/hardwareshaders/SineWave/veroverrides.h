...
#define MAXVER_INTERNALNAME "BlinnBump\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "BlinnBump.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Reflective Bump Hardware Shader\0"//should  be overidden on a per-dll level
