...
#define MAXVER_INTERNALNAME "StackBoss\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "StackBoss.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Modifier to keep custom attributes alive after a stack collapse\0"//should  be overidden on a per-dll level
