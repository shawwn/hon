...
#define MAXVER_INTERNALNAME "PolyTest\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PolyTest.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PolyMesh Testing (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: steve.anderson\0"//should  be overidden on a per-dll level
