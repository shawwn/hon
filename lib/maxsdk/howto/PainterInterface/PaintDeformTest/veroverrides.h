...
#define MAXVER_INTERNALNAME "PaintDeformTest\0" 
#define MAXVER_ORIGINALFILENAME "PaintDeformTest.dlm\0"
#define MAXVER_FILEDESCRIPTION "PaintDeformTest \0"
#define MAXVER_COMMENTS "TECH: Peter Watje\0"
