...
#define MAXVER_INTERNALNAME "CUITest\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CUITest.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "CUITest SDK Example\0"//should  be overidden on a per-dll level
