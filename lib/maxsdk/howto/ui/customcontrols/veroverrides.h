...
#define MAXVER_INTERNALNAME "custctrl\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "custctrl.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Custom control sample (plugin)\0"//should  be overidden on a per-dll level
