#define MAXVER_INTERNALNAME "Pursuit\0"//should be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Pursuit.dlo\0"//should be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Pursuit\0"//should be overidden on a per-dll level
