...
#define MAXVER_INTERNALNAME "Pursuit Resources\0"//should be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Pursuit.str\0"//should be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Pursuit Resource DLL\0"//should be overidden on a per-dll level
