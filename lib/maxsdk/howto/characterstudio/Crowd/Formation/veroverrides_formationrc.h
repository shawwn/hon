#undef MAXVER_INTERNALNAME
#undef MAXVER_ORIGINALFILENAME
#undef MAXVER_FILEDESCRIPTION
#undef MAXVER_COMMENTS

#define MAXVER_INTERNALNAME "Formation Resources\0"//should be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Formation.str\0"//should be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Formation Resource DLL\0"//should be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: Michael Zyracki\0"//should be overidden on a per-dll level
