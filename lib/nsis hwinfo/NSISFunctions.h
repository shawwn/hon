...
#define NSISDLLEXPORTFUNC extern "C" void __declspec(dllexport)
#define NSISDLLEXPORTFUNCPARAMS HWND hwndParent, int string_size, char *variables, stack_t **stacktop
