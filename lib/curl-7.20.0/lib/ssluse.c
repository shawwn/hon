 ...
 *
 * $Id: ssluse.c,v 1.3 2010/03/24 16:16:40 whitedwarf Exp $
 ***************************************************************************/
...
static bool rand_enough(void)
{
  ...
  //OutputDebugString("rand_enough start");

  status = RAND_status();

  //OutputDebugString("rand_enough finish");

  return (bool)(0 != status);
}
#else
