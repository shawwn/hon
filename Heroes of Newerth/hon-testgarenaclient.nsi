...
; Settings
;--------------------------------
Name "Heroes of Newerth Test(Garena)"
OutFile "HoNGarenaClient.exe"
...
!define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\Heroes of Newerth Test (Garena)"
!define MUI_STARTMENUPAGE_REGISTRY_VALUENAME "Start Menu Folder"

InstallDir "$PROGRAMFILES\Heroes of Newerth Test (Garena)\"
...
Section "Heroes of Newerth Test" main_install
	...
	File manifest.xml
	File change_log.txt
	File change_log_color.txt
	File change_log_history.txt
	File change_log_color_history.txt
	File ca-bundle.crt
	File s2exporter.dlu
	...
	SetOutPath "$INSTDIR\base\core\shaders"
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" base\core\shaders\common
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" base\core\shaders\ps_2_0
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" base\core\shaders\ps_3_0
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" base\core\shaders\vs_2_0
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" base\core\shaders\vs_3_0
	...
	File game\maps\tutorial.s2z
	File game\maps\watchtower.s2z
	
	SetOutPath "$INSTDIR\game\core\shaders"
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" game\core\shaders\common
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" game\core\shaders\ps_2_0
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" game\core\shaders\ps_3_0
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" game\core\shaders\vs_2_0
	File /r /x "CVS" /x ".#*" /x ".cvs*" /x "*_debug.*" game\core\shaders\vs_3_0
	...
	*/
	...
	; Overwrite compat (blank file)
	File compat\compat.s2z
	...
	; Uninstaller
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\hon" "DisplayName" "Heroes of Newerth Test (Garena)"
...
Section "un.Heroes of Newerth"
	...
	Delete "$INSTDIR\change_log_history.txt"
	Delete "$INSTDIR\change_log_color.txt"
	Delete "$INSTDIR\change_log_color_history.txt"
	Delete "$INSTDIR\ca-bundle.crt"
	Delete "$INSTDIR\s2exporter.dlu"
	Delete "$INSTDIR\compat_ignore.txt"
	;Delete "$INSTDIR\Editor.bat"
	;Delete "$INSTDIR\ModelViewer.bat"
	Delete "$INSTDIR\dedicated.bat"
	Delete "$INSTDIR\iconv.dll"
	Delete "$INSTDIR\libraries.txt"
	Delete "$INSTDIR\tos.txt"
	...
	DeleteRegKey HKCU "Software\Heroes of Newerth Test"
