...
; Settings
;--------------------------------
Name "Heroes of Newerth (Garena) Server"
...
!define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\Heroes of Newerth (Garena) Server"
!define MUI_STARTMENUPAGE_REGISTRY_VALUENAME "Start Menu Folder"

InstallDir "$PROGRAMFILES\Heroes of Newerth (Garena) Server\"
...
Section "Heroes of Newerth" main_install
	...
	; Uninstaller
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\honserver" "DisplayName" "Heroes of Newerth (Garena) Server"
